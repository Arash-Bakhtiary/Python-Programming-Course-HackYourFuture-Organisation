...
| 3.   | **Python Loops & Functions:** <br> - While Loops <br> - For Loops <br> - The Break Statement <br> - The Continue Statement <br> - Nested Loops <br> - Creating a Function (Built-in) <br> - Lambda Functions <br> - Higher-Order Functions (map(), filter(), reduce(), sorted()) <br> - Recursive Functions <br> - Arguments in Functions                                    | [Preparation](week3/preparation.md) | [Lesson plan](week3/lesson-plan.md) | [Homework](week3/homework.md) |
